...
const CreateEventForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.start_time || !formData.end_time || !formData.name || !formData.country) {
    ...
    try {
      ...
      const data = await apiService.createProgrammaticEvent(formData);
  ...
  if (!isAuthenticated) {
    return (
      <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
        <h2 className="text-2xl font-bold text-gray-800 mb-4">Crear Evento de Calendly</h2>
        <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
          <p className="text-yellow-800">
            Debes iniciar sesión con Google para crear eventos programáticos.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold text-gray-800 mb-6">Crear Evento Programático</h2>
